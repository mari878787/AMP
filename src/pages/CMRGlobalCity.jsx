...
export default function CMRGlobalCity({ project }) {
  ...
  const pillars = [
    {
      index: "01",
      title: "Positioned for Tomorrow",
      desc: "Strategically located within one of Chennai's emerging growth corridors, CMR Global City enjoys seamless connectivity to major highways, established neighbourhoods, and expanding infrastructure—placing you at the heart of tomorrow's opportunities.",
      image: "/images/project/CMR/4.png"
    },
    {
      index: "02",
      title: "Thoughtfully Developed",
      desc: "Every detail of the community is planned with enduring quality in mind. Wide internal black-top roads, solar-powered street lighting, and well-developed infrastructure create an environment that is ready for today and built to serve generations to come.",
      image: "/images/home/project-image-2.png"
    },
    {
      index: "03",
      title: "The Freedom to Build",
      desc: "Every plot is development-ready, allowing you to build without delay and entirely on your own terms. Whether creating your dream home or securing land for the future, CMR Global City offers the flexibility to bring your vision to life.",
  ...
  const layoutsData = {
    masterPlan: {
      image: '/images/project/CMR/unit-plan/CMR Master Layout-01.jpg.jpeg',
      description: 'Master Layout Plan for CMR Global City in Maduranthakam.'
    }
  };
  ...
  const handleFormSubmit = (e) => {
    ...
    const subject = encodeURIComponent(`Schedule Visit / Inquiry - CMR Global City (${fullName || 'Lead'})`);
  ...
  return (
    <div className={`project-detail-page ${hideMainHeader ? 'hide-main-header' : ''}`}>
      <Navbar projectTitle="CMR Global City" />
      <main>
        {/* Project Hero Section */}
        <section className="project-hero-section">
          <div className="project-hero-background">
            <picture className="project-hero-picture">
              <source media="(max-width: 768px)" srcSet="/images/project/CMR/mobile-hero.png" />
              <img
                src="/images/project/CMR/hero.png"
                alt="CMR Global City Villa Plots in Maduranthakam"
            ...
            <ScrollReveal animation="fadeUp" delay={0.1}>
              <div className="project-hero-text-block">
                ...
                <p className="project-hero-subtitle">
                  Where Opportunity Meets Enduring Value
                </p>
              </div>
            </ScrollReveal>
        ...
        <div className="project-sections-container">
                ...
                <div className="overview-editorial-grid">
                  ...
                  <ScrollReveal animation="fadeRight" delay={0.2}>
                    <div className="overview-img-container" style={{ position: 'relative', width: '100%', minHeight: '380px', maxHeight: '480px', overflow: 'hidden', borderRadius: '4px' }}>
                      <img
                        src="/images/project/CMR/overview.png"
                        alt="CMR Global City Overview"
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', paddingBottom: '20px' }}>
                    ...
                    <ScrollReveal animation="fadeUp" delay={0.25}>
                      <p style={{ color: 'var(--color-text-dark)', margin: '10px 0 0', fontSize: '20px', textAlign: 'justify' }}>
                        CMR Global City is a thoughtfully planned gated villa plot community in Maduranthakam, where accessible ownership meets enduring value.
                      </p>
                    </ScrollReveal>

                    <ScrollReveal animation="fadeUp" delay={0.3}>
                      <p style={{ color: 'var(--color-text-dark)', margin: 0, fontSize: '20px', textAlign: 'justify' }}>
                        Designed for those who seek a secure investment, future growth, and the freedom to build a home of their own, CMR Global City offers the ideal balance of tranquillity, connectivity, and long-term potential. Set within one of Chennai's emerging growth corridors, every plot represents an opportunity to invest in a location defined not only by what it offers today, but by the value it is poised to create for generations.
                      </p>
                    </ScrollReveal>
                  </div>
                </div>
                  ...
                  <div className="overview-left-visual">
                    <ScrollReveal animation="fadeRight" delay={0.1}>
                      <div className="overview-image-wrapper">
                        <img src="/images/project/CMR/why-project.png" alt="CMR Global City Community" />
                      </div>
                    </ScrollReveal>
                  </div>
          ...
          {activeTab === 'pricing' && (
            <ProjectPricingSection
              projectName="CMR Global City"
              unitTypes={['Villa Plots', 'Residential Plots']}
            />
          )}
          ...
          >
            <picture style={{ display: 'block', width: '100%' }}>
              <source media="(max-width: 768px)" srcSet="/images/project/CMR/CTA-mobile.png" />
              <img
                src="/images/project/CMR/CTA.png"
                alt="CMR Global City - Where Opportunity Meets Enduring Value"
                style={{
                  width: '100%',
                  height: 'auto',
                  display: 'block',
